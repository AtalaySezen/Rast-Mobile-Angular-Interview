...
import { SocialMediaData, SocialMediaModel, SocialMediaModelEdit } from '../models/socialMedia.model';
...
export class DataService {
  ...
  UpdateSocialMedia(id: string, data: SocialMediaModelEdit): Observable<SocialMediaModelEdit> {
    return this.http.put<SocialMediaModelEdit>(environment.apiUrl + `socialMedia/${id}`, data);
  }
